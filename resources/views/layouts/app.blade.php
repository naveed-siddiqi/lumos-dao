                ...
                <div class="modal-content fa-modal-content p-0 m-0">
                    <div class="container">
                        <ul class="nav nav-tabs fa-nav-tabs" id="myTabs">
                            <li class="">
                                <a class="nav-link fa-nav-link active" id="tab1" data-bs-toggle="tab" href="#profile">Profile</a>
                            </li>
                            <li class="">
                                <a class="nav-link fa-nav-link" id="tab2" data-bs-toggle="tab" href="#security">Security</a>
                            </li>
                        </ul>

                        <div class="tab-content">
                            <div class="tab-pane fade show active fa-ctn" id="profile">
                                <div class="w-100 h-100 border fa-profile-sett">
