                ...
                <div class="modal-body p-2">
                    ...
                    <div class="m-0 mt-0 mt-md-5 p-0">
                        ...
                        <div
                            ...
                            <div
                                class="d-flex flex-column flex-md-row align-items-start align-md-items-center gap-1 w-100">
                                <img class="" src="{{asset('/images/discord.png')}}" alt="">
                                <p class="mb-0  column-content text-truncate text-break text-wrap">
                                    FGDKXQTCPOJVVBBYSNADBDSJBASD2MRK2DXKZANU3I</p>
                            </div>
                            <div class="mb-3">
                    ...
                    <div class="m-0 py-2 p-0">
                        ...
                        <div
                            ...
                            <div
                                class="d-flex align-items-start align-md-items-end justify-content-start justify-content-md-end gap-2 mt-2 w-100">
    ...
    <div class="container">
        <div class="d-flex proposal_card_container">
          ...
          <div style="margin-top: 40px; max-height:500px; overflow-y:scroll" class="proposal_status-card w-100 py-3">
            ...
            <div style="margin-top: 20px; " class="proposal_status-card w-100">
