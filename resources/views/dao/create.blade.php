...
@section('content')
    ...
    <section class="container">
            <div>
                <div class=" my-5">
                        <div class="Create-dao-section">
                            <h4>2.Create DAO for a new Steller project</h4>
                ...
                <form action="" onsubmit="event.preventDefault()">
                    <div class="grid-form">
                        ...
                        <div style="grid-column: span 5 / span 5;" class="form-group">
                            ...
                            <div class="container_custom_file_input">
                                <div class="custom-file" style="position: relative;">
                                    <input id='cover_o_photo' type="file" class="custom-file-input">
                                    <label class="custom-file-label py-4" for="customFile" style='display:flex;flex-direction:row'>
                                        <span id='cover_o_photo_msg'>Add Cover</span>
                                        <div class="">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" width="24px">
                                                <path stroke-linecap="round" stroke-linejoin="round" d="M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V16.5M16.5 12L12 16.5m0 0L7.5 12m4.5 4.5V3" />
                                            </svg>
        ...
        const createODao = async (event) => {
            ...
            if(aCode != "" && aSupply != "" && name != "" && about != "" && upload_file != null) {
                if(isSafeToml(aCode) && isSafeToml(name) && isSafeToml(about)) {
                    ...
                    let res = await deployStellarAsset(new S.Asset(aCode, walletAddress))
                    if(res === false) {
                        //unwrapped token
