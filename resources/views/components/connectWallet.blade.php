    ...
    <div class="modal fade" id="ConnectWallet"
        {{-- {{ !isset($_COOKIE['public']) ? 'data-bs-backdrop=static data-bs-keyboard=false' : '' }} --}}
         tabindex="-1"
                        ...
                        <div class="col-12 text-center">
                            ...
                            <label class="drop">
                                ...
                                <ul class="drop-items " id="walltetList">
                                    <li class="item-drop wallet-drop-items">
                                        <a href="#" wallet="rabet"><img src="{{ asset('images/rabet.png') }}"> Rabet</a>
                                    </li>
                                    <li class="item-drop wallet-drop-items">
                                        <a href="#" wallet="frighter"><img src="{{ asset('images/frighter.png') }}">Frighter</a>
                                    </li>
                                    <li class="item-drop wallet-drop-items">
                                        <a href="#" wallet="albeto"><img src="{{ asset('images/albeto.png') }}">Albedo</a>
                                    </li>
                                    <li class="item-drop wallet-drop-items">
                                        <a href="#" wallet="xbull"><img src="{{ asset('images/xbull.png') }}">Xbull</a>
                                    </li>
                                    {{-- <li class="item-drop wallet-drop-items">
                            ...
                            <div class="w-100">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="cont-btn">
                                            <a onclick="connectWallet()" type="button"
